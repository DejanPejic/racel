// gcc -o irm1 irm1.c l bcm2835 -l lirc_clien t
// sudo ./irm1
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
// LED3 je da DVK512 plocici na P28 sto je pin 20 na BCM-u,
// ako se koristi protobord moze se 
...
int main(int argc, char **argv)
{
	...
	// radimo dok je LIRC soket otvoren 0=otvoren -1=zatvoren	
		...
		{
			//if code=NULL nista nije primljeno - preskoci
